...
# expand "System"
driver.find_element(By.XPATH, '//tr[@title="System"]').click()

# expand "Tools"
driver.find_element(By.XPATH, '//tr[@title="Tools"]').click()
...
# click on "Import"
driver.find_element(By.XPATH, '//tr[@title="Import"]').click()
...
driver.find_element(By.ID, 'UploadToImpExMediaEditor[in Attribute[ImpExImportWizard.jobMedia]]_uploading').click()
...
driver.find_element(By.XPATH, '//td[contains(text(), "Upload")]').click()
driver.switch_to.window(wizard_win_handle)
...
driver.find_element(By.ID, 'UploadToMediaEditor[in Attribute[ImpExImportWizard.mediasZip]]_uploading').click()
...
xpath_for_impex_input = '//input[@class="modalMediaFileUploadChip"]'
driver.find_element(By.XPATH, xpath_for_impex_input).send_keys(args.media)
...
driver.find_element(By.XPATH, '//a[@title="Start"]').click()

# wait until importing is finished
result_text = WebDriverWait(driver, 60).until(
    lambda x: driver.find_element(By.ID, 'ItemDisplay[FINISHED]_div').find_element(By.XPATH,
